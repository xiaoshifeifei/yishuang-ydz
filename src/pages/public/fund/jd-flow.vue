 ...
 * @LastEditTime: 2020-07-06 15:40:03
...
<template>
    <div id="jd-flow">
        <uiTitle class="title" ref="title" :isback="true" :title="'京东流水详情'" :color="'white'"></uiTitle> 
...
export default {
    ...
    mounted(){
        this.$refs.scroll.$el.style.height = document.getElementById('jd-flow').offsetHeight - this.$refs.title.$el.style.height +'px';
    }
}
</script>
